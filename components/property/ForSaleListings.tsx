...
type ForSaleListingsProps = {
  initialProperties?: Property[];
};

export default function ForSaleListings({ initialProperties }: ForSaleListingsProps) {
  const [properties, setProperties] = useState<Property[]>(
    sortPropertiesNewestFirst(initialProperties?.length ? initialProperties : STATIC_PROPERTY_CATALOG) as Property[]
  );
